    ...
    <div className=" max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className=" flex flex-col h-full justify-center">
        ...
        <p className=" pb-6">
          ...
          minus, totam explicabo praesentium molestias cumque tenetur? Molestias
          velit consequuntur, eaque aspernatur nostrum quidem deserunt officiis
          autem cumque repellat asperiores?
        </p>
        <div>
          <button className=" border-black hover:shadow-xl mr-4">
            Learn More
          </button>
          <button className=" border-black hover:shadow-xl bg-black text-white">
            Book Your Trip
          </button>
        </div>
      </div>
